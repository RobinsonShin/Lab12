...
public class Oval extends Shape
{
    ...
    public void draw(Graphics graphics)
    {
        ...
        if (this.isFilled())
        {
            graphics.fillOval(location[0].x-radius1, location[0].y-radius2, diameter1, diameter2);
        } 
        else
        {
            graphics.drawOval(location[0].x-radius1, location[0].y-radius2, diameter1, diameter2);
        }
    }
}
